...
namespace TannersWebsiteTemplate.SQL
{
    public static class Main
    {
        ...
        public static bool TryConnectionString()
        {
            ...
            {
                _ = Logger.Write("SQL: Something is wrong with the SQL connection string.\nError provided: " + e.Message + "\nSQL: Error Code: " + e.ErrorCode, "SQL");
                Console.WriteLine("SQL: Something is wrong with the SQL connection string.\nError provided: " + e.Message + "\nSQL: Error Code: " + e.ErrorCode);
                return false;
            }
            catch (Exception ex)
            {
                _ = Logger.Write("SQL: Something is wrong with the SQL connection string that caused a regular exception.\nError provided: " + ex.Message, "SQL");
                Console.WriteLine("SQL: Something is wrong withthe SQL connection string that caused a regular exception.\nError provided: " + ex.Message);
                return false;
            }
        }
    }
