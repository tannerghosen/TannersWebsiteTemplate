    ...
    public static class Tables
    {
        public static void Accounts()
        {
            using (var con = Main.Connect())
            {
                ...
                // Accounts Table
                string accounts = "CREATE TABLE IF NOT EXISTS accounts (id INT(11) PRIMARY KEY AUTO_INCREMENT, email VARCHAR(255) NOT NULL UNIQUE, username VARCHAR(50) NOT NULL UNIQUE COLLATE utf8mb4_bin, password TEXT NOT NULL, sessionid VARCHAR(36), isadmin TINYINT DEFAULT 0, isexternal TINYINT DEFAULT 0, joined DATETIME DEFAULT CURRENT_TIMESTAMP)";
